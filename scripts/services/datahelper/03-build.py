...
def build():
    parser = argparse.ArgumentParser(description="Build DataHelper Service")
    ...
    publish_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../publish/PoC-DataHelper"))
